...
```html	
<div>
<!-- link will fire History.pushState() event. Data from the request will replace content of the container that was passed to Wiselinks (default to 'body') -->

<a href='/path' data-push='true'>wiselinks are awesome</a>

<!-- link will fire History.replaceState() event. Data from the request will replace content of the container that was passed to Wiselinks (default to 'body') -->
